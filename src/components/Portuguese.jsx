...
function Portuguese() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        fetch('http://localhost:3001/Portuguese', {
            method: 'POST',
            headers: {
        ...
        <div className="French p-4 sm:ml-64 static">
            <div className="flex h-full flex-col">
                <div className="flex justify-center">
                    <img src={require('../assets/Brazil.png')} className={"h-52 rounded-full border-2 border-black"} />
                </div>
                        ...
                        <div className="flex flex-col" key={index}>
                            ...
                            <div className="flex justify-start">
                                <div className="flex items-center w-full max-w-xs p-4 space-x-4 text-white rounded-lg shadow bg-gray-700 top-15 left-5">
                                    <img src={require('../assets/Brazil.png')} className="w-10 h-10 rounded-full" alt="Rounded avatar" />
                                    <div className="text-start text-sm font-normal">Señor Silva : {conversation.response}</div>
                                </div>
                            </div>
                        </div>
                    ))}
